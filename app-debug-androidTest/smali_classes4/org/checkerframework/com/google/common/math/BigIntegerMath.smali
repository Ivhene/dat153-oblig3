.class public final Lorg/checkerframework/com/google/common/math/BigIntegerMath;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->SQRT2_PRECOMPUTED_BITS:Ljava/math/BigInteger;
    ...
    sput-wide v0, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->LN_10:D
    ...
    sput-wide v0, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->LN_2:D
...
.method public static binomial(II)Ljava/math/BigInteger;
    ...
    invoke-static {v0, p1}, Lorg/checkerframework/com/google/common/math/MathPreconditions;->checkNonNegative(Ljava/lang/String;I)I
    ...
    invoke-static {v0, v1, p1, p0}, Lorg/checkerframework/com/google/common/base/Preconditions;->checkArgument(ZLjava/lang/String;II)V
    ...
    .line 426
    :cond_1
    sget-object v0, Lorg/checkerframework/com/google/common/math/LongMath;->biggestBinomials:[I
    ...
    .line 427
    invoke-static {p0, p1}, Lorg/checkerframework/com/google/common/math/LongMath;->binomial(II)J
    ...
    invoke-static {v5, v6, v7}, Lorg/checkerframework/com/google/common/math/LongMath;->log2(JLjava/math/RoundingMode;)I
...
.method public static ceilingPowerOfTwo(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {p0, v1}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->log2(Ljava/math/BigInteger;Ljava/math/RoundingMode;)I
...
.method public static factorial(I)Ljava/math/BigInteger;
    ...
    invoke-static {v1, v0}, Lorg/checkerframework/com/google/common/math/MathPreconditions;->checkNonNegative(Ljava/lang/String;I)I

    .line 339
    sget-object v1, Lorg/checkerframework/com/google/common/math/LongMath;->factorials:[J
    ...
    invoke-static {v0, v1}, Lorg/checkerframework/com/google/common/math/IntMath;->log2(ILjava/math/RoundingMode;)I
    ...
    invoke-static {v1, v3, v2}, Lorg/checkerframework/com/google/common/math/IntMath;->divide(IILjava/math/RoundingMode;)I
    ...
    sget-object v4, Lorg/checkerframework/com/google/common/math/LongMath;->factorials:[J

    array-length v4, v4

    .line 349
    .local v4, "startingNumber":I
    sget-object v5, Lorg/checkerframework/com/google/common/math/LongMath;->factorials:[J
    ...
    invoke-static {v5, v6, v8}, Lorg/checkerframework/com/google/common/math/LongMath;->log2(JLjava/math/RoundingMode;)I
    ...
    invoke-static {v10, v11, v12}, Lorg/checkerframework/com/google/common/math/LongMath;->log2(JLjava/math/RoundingMode;)I
    ...
    invoke-static {v5, v6, v14}, Lorg/checkerframework/com/google/common/math/LongMath;->log2(JLjava/math/RoundingMode;)I
    ...
    .line 387
    :cond_4
    invoke-static {v2}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->listProduct(Ljava/util/List;)Ljava/math/BigInteger;
...
.method static listProduct(Ljava/util/List;)Ljava/math/BigInteger;
    ...
    invoke-static {p0, v0, v1}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->listProduct(Ljava/util/List;II)Ljava/math/BigInteger;
...
.method static listProduct(Ljava/util/List;II)Ljava/math/BigInteger;
    ...
    .line 407
    .local v0, "m":I
    invoke-static {p0, p1, v0}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->listProduct(Ljava/util/List;II)Ljava/math/BigInteger;

    move-result-object v1

    invoke-static {p0, v0, p2}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->listProduct(Ljava/util/List;II)Ljava/math/BigInteger;
...
.method public static log10(Ljava/math/BigInteger;Ljava/math/RoundingMode;)I
    ...
    invoke-static {v0, p0}, Lorg/checkerframework/com/google/common/math/MathPreconditions;->checkPositive(Ljava/lang/String;Ljava/math/BigInteger;)Ljava/math/BigInteger;

    .line 150
    invoke-static {p0}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->fitsInLong(Ljava/math/BigInteger;)Z
    ...
    invoke-static {v0, v1, p1}, Lorg/checkerframework/com/google/common/math/LongMath;->log10(JLjava/math/RoundingMode;)I
    ...
    invoke-static {p0, v0}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->log2(Ljava/math/BigInteger;Ljava/math/RoundingMode;)I

    move-result v0

    int-to-double v0, v0

    sget-wide v2, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->LN_2:D

    mul-double/2addr v0, v2

    sget-wide v2, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->LN_10:D
    ...
    .line 190
    .local v5, "floorCmp":I
    sget-object v6, Lorg/checkerframework/com/google/common/math/BigIntegerMath$1;->$SwitchMap$java$math$RoundingMode:[I
    ...
    :goto_4
    invoke-static {v6}, Lorg/checkerframework/com/google/common/math/MathPreconditions;->checkRoundingUnnecessary(Z)V
...
.method public static log2(Ljava/math/BigInteger;Ljava/math/RoundingMode;)I
    ...
    invoke-static {v1, v0}, Lorg/checkerframework/com/google/common/math/MathPreconditions;->checkPositive(Ljava/lang/String;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    .line 92
    .local v0, "logFloor":I
    sget-object v1, Lorg/checkerframework/com/google/common/math/BigIntegerMath$1;->$SwitchMap$java$math$RoundingMode:[I
    ...
    .line 107
    sget-object v1, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->SQRT2_PRECOMPUTED_BITS:Ljava/math/BigInteger;
    ...
    :pswitch_1
    invoke-static {p0}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->isPowerOfTwo(Ljava/math/BigInteger;)Z
    ...
    invoke-static {v1}, Lorg/checkerframework/com/google/common/math/MathPreconditions;->checkRoundingUnnecessary(Z)V
...
.method public static sqrt(Ljava/math/BigInteger;Ljava/math/RoundingMode;)Ljava/math/BigInteger;
    ...
    invoke-static {v0, p0}, Lorg/checkerframework/com/google/common/math/MathPreconditions;->checkNonNegative(Ljava/lang/String;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {v0, v1, p1}, Lorg/checkerframework/com/google/common/math/LongMath;->sqrt(JLjava/math/RoundingMode;)J
    ...
    .line 231
    :cond_0
    invoke-static {p0}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->sqrtFloor(Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method private static sqrtApproxWithDoubles(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    .line 306
    invoke-static {p0}, Lorg/checkerframework/com/google/common/math/DoubleUtils;->bigToDouble(Ljava/math/BigInteger;)D
    ...
    invoke-static {v0, v1, v2}, Lorg/checkerframework/com/google/common/math/DoubleMath;->roundToBigInteger(DLjava/math/RoundingMode;)Ljava/math/BigInteger;
...
.method private static sqrtFloor(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    .line 284
    invoke-static {p0}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->sqrtApproxWithDoubles(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Lorg/checkerframework/com/google/common/math/BigIntegerMath;->sqrtApproxWithDoubles(Ljava/math/BigInteger;)Ljava/math/BigInteger;
