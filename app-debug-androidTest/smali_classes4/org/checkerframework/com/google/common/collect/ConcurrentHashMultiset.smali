.class public final Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$EntrySet;,
        Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$FieldSettersHolder;
    }
.end annotation
...
.method constructor <init>(Ljava/util/concurrent/ConcurrentMap;)V
    ...
    .line 126
    .local p0, "this":Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;, "Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset<TE;>;"
    ...
    .line 128
    iput-object p1, p0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->countMap:Ljava/util/concurrent/ConcurrentMap;

    .line 129
    return-void
.end method

.method static synthetic access$100(Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;)Ljava/util/concurrent/ConcurrentMap;
    .locals 1
    .param p0, "x0"    # Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;

    .line 59
    iget-object v0, p0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->countMap:Ljava/util/concurrent/ConcurrentMap;

    return-object v0
.end method

.method public static create()Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
            "Ljava/lang/Object;",
            ">()",
            "Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset<",
            "TE;>;"
        }
    .end annotation

    .line 89
    new-instance v0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;

    new-instance v1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    invoke-direct {v0, v1}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;-><init>(Ljava/util/concurrent/ConcurrentMap;)V

    return-object v0
.end method

.method public static create(Ljava/lang/Iterable;)Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-static {}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->create()Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;

    move-result-object v0

    .line 102
    .local v0, "multiset":Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;, "Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset<TE;>;"
...
.method public static create(Ljava/util/concurrent/ConcurrentMap;)Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-direct {v0, p0}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;-><init>(Ljava/util/concurrent/ConcurrentMap;)V
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    sget-object v1, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$FieldSettersHolder;->COUNT_MAP_FIELD_SETTER:Lorg/checkerframework/com/google/common/collect/Serialization$FieldSetter;
...
.method private snapshot()Ljava/util/List;
    ...
    .line 180
    .local p0, "this":Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;, "Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset<TE;>;"
    invoke-virtual {p0}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->size()I

    move-result v0

    invoke-static {v0}, Lorg/checkerframework/com/google/common/collect/Lists;->newArrayListWithExpectedSize(I)Ljava/util/ArrayList;

    move-result-object v0

    .line 181
    .local v0, "list":Ljava/util/List;, "Ljava/util/List<TE;>;"
    invoke-virtual {p0}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->entrySet()Ljava/util/Set;
...
.method public add(Ljava/lang/Object;I)I
    ...
    .line 206
    invoke-virtual {p0, p1}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->count(Ljava/lang/Object;)I
    ...
    invoke-static {p2, v0}, Lorg/checkerframework/com/google/common/collect/CollectPreconditions;->checkPositive(ILjava/lang/String;)V
    ...
    .line 213
    iget-object v2, p0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->countMap:Ljava/util/concurrent/ConcurrentMap;
    ...
    .line 224
    :try_start_0
    invoke-static {v2, p2}, Lorg/checkerframework/com/google/common/math/IntMath;->checkedAdd(II)I
    ...
    iget-object v4, p0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->countMap:Ljava/util/concurrent/ConcurrentMap;
...
.method createElementSet()Ljava/util/Set;
    ...
    new-instance v1, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$1;

    invoke-direct {v1, p0, v0}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$1;-><init>(Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;Ljava/util/Set;)V
...
.method public createEntrySet()Ljava/util/Set;
    ...
    .line 487
    .local p0, "this":Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;, "Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset<TE;>;"
    new-instance v0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$EntrySet;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$EntrySet;-><init>(Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$1;)V
...
.method entryIterator()Ljava/util/Iterator;
    ...
    .line 504
    .local p0, "this":Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;, "Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset<TE;>;"
    new-instance v0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$2;

    invoke-direct {v0, p0}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$2;-><init>(Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;)V

    .line 524
    .local v0, "readOnlyIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Lorg/checkerframework/com/google/common/collect/Multiset$Entry<TE;>;>;"
    new-instance v1, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$3;

    invoke-direct {v1, p0, v0}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset$3;-><init>(Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;Ljava/util/Iterator;)V
...
.method public remove(Ljava/lang/Object;I)I
    ...
    .line 288
    iget-object v1, p0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->countMap:Ljava/util/concurrent/ConcurrentMap;
...
.method public removeExactly(Ljava/lang/Object;I)Z
    ...
    invoke-static {p2, v1}, Lorg/checkerframework/com/google/common/collect/CollectPreconditions;->checkPositive(ILjava/lang/String;)V
...
.method public setCount(Ljava/lang/Object;II)Z
    ...
    .line 416
    :cond_1
    iget-object v3, p0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->countMap:Ljava/util/concurrent/ConcurrentMap;
    ...
    iget-object v5, p0, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->countMap:Ljava/util/concurrent/ConcurrentMap;
...
.method public toArray()[Ljava/lang/Object;
    ...
    .line 167
    .local p0, "this":Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;, "Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset<TE;>;"
    invoke-direct {p0}, Lorg/checkerframework/com/google/common/collect/ConcurrentHashMultiset;->snapshot()Ljava/util/List;
