.class public Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;
...
.method static constructor <clinit>()V
    ...
    .line 40
    .local v0, "initialMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/CharSequence;Ljava/lang/CharSequence;>;"
    const-string v1, "\u00a0"
    ...
    sput-object v1, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->ISO8859_1_ESCAPE:Ljava/util/Map;

    .line 144
    .end local v0    # "initialMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/CharSequence;Ljava/lang/CharSequence;>;"
    invoke-static {v1}, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->invert(Ljava/util/Map;)Ljava/util/Map;
    ...
    sput-object v0, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->ISO8859_1_UNESCAPE:Ljava/util/Map;
    ...
    .line 157
    .restart local v0    # "initialMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/CharSequence;Ljava/lang/CharSequence;>;"
    const-string v1, "\u0192"
    ...
    sput-object v1, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->HTML40_EXTENDED_ESCAPE:Ljava/util/Map;
    ...
    sput-object v0, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->HTML40_EXTENDED_UNESCAPE:Ljava/util/Map;
    ...
    sput-object v1, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->BASIC_ESCAPE:Ljava/util/Map;
    ...
    sput-object v0, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->BASIC_UNESCAPE:Ljava/util/Map;
    ...
    sput-object v1, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->APOS_ESCAPE:Ljava/util/Map;
    ...
    sput-object v0, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->APOS_UNESCAPE:Ljava/util/Map;
    ...
    sput-object v1, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->JAVA_CTRL_CHARS_ESCAPE:Ljava/util/Map;
    ...
    sput-object v0, Lorg/checkerframework/org/apache/commons/text/translate/EntityArrays;->JAVA_CTRL_CHARS_UNESCAPE:Ljava/util/Map;
...
.method public static invert(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 435
    .local p0, "map":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/CharSequence;Ljava/lang/CharSequence;>;"
    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    .line 436
    .local v0, "newMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/CharSequence;Ljava/lang/CharSequence;>;"
    ...
    .line 437
    .local v2, "pair":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/CharSequence;Ljava/lang/CharSequence;>;"
    ...
    .line 438
    .end local v2    # "pair":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/CharSequence;Ljava/lang/CharSequence;>;"
    goto :goto_0
