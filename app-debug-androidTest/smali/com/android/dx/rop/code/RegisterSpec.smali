...
.method private static intern(ILcom/android/dx/rop/type/TypeBearer;Lcom/android/dx/rop/code/LocalItem;)Lcom/android/dx/rop/code/RegisterSpec;
    ...
    .line 72
    .local v0, "interningItem":Lcom/android/dx/rop/code/RegisterSpec$ForComparison;
    ...
    .line 73
    sget-object v1, Lcom/android/dx/rop/code/RegisterSpec;->theInterns:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 74
    .local v2, "found":Lcom/android/dx/rop/code/RegisterSpec;
    if-nez v2, :cond_0
    ...
    .line 76
    invoke-virtual {v1, v2, v2}, Ljava/util/concurrent/ConcurrentHashMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 77
    .local v1, "existing":Lcom/android/dx/rop/code/RegisterSpec;
    if-eqz v1, :cond_0
    ...
    .line 81
    .end local v1    # "existing":Lcom/android/dx/rop/code/RegisterSpec;
    :cond_0
    return-object v2
.end method
...
.method private toString0(Z)Ljava/lang/String;
    ...
    .line 605
    .local v1, "justType":Lcom/android/dx/rop/type/Type;
    ...
    instance-of v3, v2, Lcom/android/dx/rop/cst/Constant;
...
.method public compareTo(Lcom/android/dx/rop/code/RegisterSpec;)I
    ...
    .line 272
    :cond_6
    invoke-virtual {v4, v0}, Lcom/android/dx/rop/code/LocalItem;->compareTo(Lcom/android/dx/rop/code/LocalItem;)I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v1, v2, v3}, Lcom/android/dx/rop/code/RegisterSpec;->equals(ILcom/android/dx/rop/type/TypeBearer;Lcom/android/dx/rop/code/LocalItem;)Z
    ...
    iget v1, v0, Lcom/android/dx/rop/code/RegisterSpec;->reg:I

    iget-object v2, v0, Lcom/android/dx/rop/code/RegisterSpec;->type:Lcom/android/dx/rop/type/TypeBearer;

    iget-object v3, v0, Lcom/android/dx/rop/code/RegisterSpec;->local:Lcom/android/dx/rop/code/LocalItem;
...
.method public intersect(Lcom/android/dx/rop/code/RegisterSpec;Z)Lcom/android/dx/rop/code/RegisterSpec;
    ...
    .line 475
    .local v3, "thisType":Lcom/android/dx/rop/type/Type;
    invoke-virtual {p1}, Lcom/android/dx/rop/code/RegisterSpec;->getType()Lcom/android/dx/rop/type/Type;

    move-result-object v4

    .line 478
    .local v4, "otherType":Lcom/android/dx/rop/type/Type;
    if-eq v3, v4, :cond_6
    ...
    .line 485
    .local v0, "resultTypeBearer":Lcom/android/dx/rop/type/TypeBearer;
    :goto_3
    ...
    invoke-static {v5, v0}, Lcom/android/dx/rop/code/RegisterSpec;->make(ILcom/android/dx/rop/type/TypeBearer;)Lcom/android/dx/rop/code/RegisterSpec;
    ...
    .line 491
    :cond_9
    invoke-static {v5, v0, v1}, Lcom/android/dx/rop/code/RegisterSpec;->make(ILcom/android/dx/rop/type/TypeBearer;Lcom/android/dx/rop/code/LocalItem;)Lcom/android/dx/rop/code/RegisterSpec;
    ...
    .line 462
    .end local v0    # "resultTypeBearer":Lcom/android/dx/rop/type/TypeBearer;
    .end local v1    # "resultLocal":Lcom/android/dx/rop/code/LocalItem;
    .end local v2    # "sameName":Z
    .end local v3    # "thisType":Lcom/android/dx/rop/type/Type;
    .end local v4    # "otherType":Lcom/android/dx/rop/type/Type;
    :cond_a
    :goto_5
    return-object v0
.end method
...
.method public withSimpleType()Lcom/android/dx/rop/code/RegisterSpec;
    ...
    .line 547
    .local v0, "orig":Lcom/android/dx/rop/type/TypeBearer;
    ...
    .local v1, "newType":Lcom/android/dx/rop/type/Type;
    goto :goto_0

    .line 550
    .end local v1    # "newType":Lcom/android/dx/rop/type/Type;
    :cond_0
    invoke-interface {v0}, Lcom/android/dx/rop/type/TypeBearer;->getType()Lcom/android/dx/rop/type/Type;
    ...
    .line 553
    .restart local v1    # "newType":Lcom/android/dx/rop/type/Type;
    :goto_0
    ...
    invoke-static {v2, v1, v3}, Lcom/android/dx/rop/code/RegisterSpec;->makeLocalOptional(ILcom/android/dx/rop/type/TypeBearer;Lcom/android/dx/rop/code/LocalItem;)Lcom/android/dx/rop/code/RegisterSpec;
