...
.method static checkAsmExperimental(Ljava/lang/Object;)V
    ...
    .line 188
    .local v1, "internalName":Ljava/lang/String;
    invoke-static {v1}, Lnet/bytebuddy/jar/asm/Constants;->isWhitelisted(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lnet/bytebuddy/jar/asm/Constants;->checkIsPreview(Ljava/io/InputStream;)V
...
.method static checkIsPreview(Ljava/io/InputStream;)V
    .locals 3
    .param p0, "classInputStream"    # Ljava/io/InputStream;
    ...
    .line 211
    .local v0, "callerClassStream":Ljava/io/DataInputStream;
    :try_start_1
    ...
    .line 215
    .end local v0    # "callerClassStream":Ljava/io/DataInputStream;
    nop
    ...
    const-string v2, "ASM9_EXPERIMENTAL can only be used by classes compiled with --enable-preview"
    ...
    .restart local v0    # "callerClassStream":Ljava/io/DataInputStream;
    :catchall_0
    move-exception v1
    ...
    .end local p0    # "classInputStream":Ljava/io/InputStream;
    :goto_0
    :try_start_4
    throw v1
    :try_end_4
    ...
    .line 213
    .end local v0    # "callerClassStream":Ljava/io/DataInputStream;
    .restart local p0    # "classInputStream":Ljava/io/InputStream;
    :catch_0
    move-exception v0
    ...
    const-string v1, "Bytecode not available, can\'t check class version"
